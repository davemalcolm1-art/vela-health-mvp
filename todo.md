...
- [ ] Update design system: soften navy to warm sage, add warm gold accent
- [ ] Update typography: increase headline sizes, add italic serif for subheadings
- [ ] Replace all emojis with [IMAGE PLACEHOLDER] tags with descriptive notes
- [ ] Redesign hero section: warm background, lifestyle imagery placeholder, improved CTA hierarchy
- [ ] Redesign program cards: color-coded sections, remove emojis, add image placeholders
- [ ] Add subtle animations: fade-in on scroll, gentle upward drift on hero
- [ ] Increase whitespace throughout for premium feel
- [ ] Improve visual hierarchy: larger headlines, better contrast
- [ ] Add testimonial section with real people imagery placeholders
- [ ] Review and refine color palette application across all sections
